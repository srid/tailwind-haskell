...
let
  sources = {
    ...
    "@tailwindcss/line-clamp-0.3.0" = {
      ...
      version = "0.3.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@tailwindcss/line-clamp/-/line-clamp-0.3.0.tgz";
        sha512 = "ffDDclrqr3sy8cpChCozedDUAN8enxqAiWeH8d4dGQ2hcXlxf51+7KleveFi/n/TxEuRVApoL7hICeDOdYPKpg==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@tailwindcss/line-clamp-0.3.0"
